...
class OpStudentCourse(models.Model):
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/edutek_core/static/xls/op_student_course.xls'
        }]
...
class OpStudent(models.Model):
    ...
    def copy(self, default=None):
        if not self.env.context.get('edutek_allow_student_copy'):
            raise ValidationError(_('You cannot duplicate a student record.'))
        return super(OpStudent, self).copy(default)
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/edutek_core/static/xls/op_student.xls'
        }]
